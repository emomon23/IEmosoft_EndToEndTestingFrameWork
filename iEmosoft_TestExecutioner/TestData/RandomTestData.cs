...
namespace iEmosoft.RecordableBrowser.TestData
{
    public class RandomTestData
    {
        ...
        {
            return FirstNames[rnd.Next(0, FirstNames.Count - 0)];
        }

        public string GetRandomLastName()
        {
             return LastNames[rnd.Next(0, LastNames.Count - 0)];
        }

        public string GetRandomCompanyName()
        {
            return CompanyNames[rnd.Next(0, CompanyNames.Count - 0)];
        }

        public string GetRandomCity()
        {
             return Cities[rnd.Next(0, Cities.Count - 0)];
        }
        ...
        {
            return string.Format("{0}{1}", rnd.Next(3, 9), GetRandomDigits(4));
        }

        public string GetRandomEmailAddress(){
            return GetRandomEmailAddress(GetRandomFirstName(), GetRandomLastName());
        }
